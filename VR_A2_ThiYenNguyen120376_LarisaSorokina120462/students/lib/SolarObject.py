...
import lib.OrbitVisualization as OV
...
class SolarObject:
    ...
    def __init__(self,
        ...
        self.rotation_velocity = ORBIT_INCLINATION *0.01
        ...
        ## Ex 2.4
        self.orbit_inclination_node = avango.gua.nodes.TransformNode(Name=NAME + "_orbit_inclination_node") #declare a node (TransformNode)_
        self.orbit_inclination_node.Transform.value = avango.gua.make_rot_mat(self.orbit_inclination, 0.0, 0.0, 1.0) #apply transform for the node
        PARENT_NODE.Children.value.append(self.orbit_inclination_node) #add node to PARENT_NODE parent
        ...
        ## Ex 2.3
        self.orbit_visualization = OV.OrbitVisualization(self.orbit_inclination_node, self.orbit_radius)
